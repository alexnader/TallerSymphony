...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d565_1' => 'get0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d5651Service',
            ...
            'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_1' => 'getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b1Service',
            'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_2' => 'getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b2Service',
            'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_3' => 'getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b3Service',
    ...
    /**
     * Gets the '0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d565_1' service.
     *
     ...
     */
    protected function get0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d5651Service()
    {
        return $this->services['0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d565_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/tallerSymphony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/tallerSymphony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/tallerSymphony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/tallerSymphony/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tallerSymfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_2a13bc038baab40bd0ec4941a6f4c60b55317b0f259dadc5c15cd6580ebcc966');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2a13bc038baab40bd0ec4941a6f4c60b55317b0f259dadc5c15cd6580ebcc966');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2a13bc038baab40bd0ec4941a6f4c60b55317b0f259dadc5c15cd6580ebcc966');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\tallerSymphony\\src\\EMM\\ProductBundle\\Entity')), 'EMM\\ProductBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('EMMProductBundle' => 'EMM\\ProductBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/wamp/www/tallerSymphony/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b1Service()
    {
        return $this->services['fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b2Service()
    {
        return $this->services['fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b3Service()
    {
        return $this->services['fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/tallerSymphony/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('0e5ca99eda27cb7ee90666a327a6bae91097f27a7b76dbeaaf4bbce444f8d565_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/tallerSymphony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/tallerSymphony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/tallerSymphony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/tallerSymphony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/tallerSymphony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/tallerSymphony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/tallerSymphony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_1'), 1 => $this->get('fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_2'), 2 => $this->get('fcefcb632e2bfcb31c21c8d7fbd12a4894beb9781d442dda3f4d92ec552bc53b_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/tallerSymphony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/tallerSymphony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/tallerSymphony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/tallerSymphony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\src\\EMM\\ProductBundle/Resources/views', 'EMMProduct');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/tallerSymphony/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ebdc6d0e6055fc02073222b76f6b50b49e5584ef');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\tallerSymphony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/tallerSymphony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/tallerSymphony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/tallerSymphony/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/tallerSymphony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/tallerSymphony/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/tallerSymphony/app/logs',
            'kernel.bundles' => array(
                ...
                'EMMProductBundle' => 'EMM\\ProductBundle\\EMMProductBundle',
            ...
            'locale' => 'en',
            'secret' => 'ebdc6d0e6055fc02073222b76f6b50b49e5584ef',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => 'C:/wamp/www/tallerSymphony/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'ebdc6d0e6055fc02073222b76f6b50b49e5584ef',
            ...
            'session.save_path' => 'C:/wamp/www/tallerSymphony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/tallerSymphony/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/tallerSymphony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/tallerSymphony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/tallerSymphony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/tallerSymphony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/tallerSymphony/app/../web',
            'assetic.write_to' => 'C:/wamp/www/tallerSymphony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/tallerSymphony/app/cache/dev/doctrine/orm/Proxies',
